...
## Project Context
- Backend: Spring Boot 3.x (Spring Web), Spring Data JPA, SQLite (or H2 for development).
- UI: Thymeleaf Templates + vanilla JS (fetch API), static assets in src/main/resources/static.
- Deployment: A single executable JAR file serving both the REST API and the UI views.

## Documentation Requirements

### 1. Inline Code Comments
- **Controllers**: Add comments explaining endpoint purposes, parameters, and return types
